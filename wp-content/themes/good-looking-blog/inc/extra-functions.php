...
if ( ! function_exists( 'good_looking_blog_site_branding' ) ) :
    /**
     * Site Branding
     */
    function good_looking_blog_site_branding(){
        ?>
        <div class="site-branding" itemscope itemtype="https://schema.org/Organization">
            ...
            $good_looking_blog_description = get_bloginfo( 'description', 'display' );
            if ( $good_looking_blog_description || is_customize_preview() ) :
                ?>
                <p class="site-description" itemprop="description"><?php echo $good_looking_blog_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
            <?php endif; ?>
        </div><!-- .site-branding -->
        <?php
    }
...
if ( ! function_exists( 'good_looking_blog_primary_navigation' ) ) :
    /**
    * Primary Navigation
    */
    function good_looking_blog_primary_navigation( $schema = true ){
                ...
                <?php
                    wp_nav_menu(
                        array(
                            ...
                            'fallback_cb'     => 'good_looking_blog_primary_menu_fallback',
                        )
                    );
                ?>
            </nav>
...
if( ! function_exists( 'good_looking_blog_social_links' ) ) :
	/**
	 * Social Links 
	*/
    function good_looking_blog_social_links( $echo = true ){ 
        ...
        <ul class="social-links">
            ...
            foreach( $social_links as $link ){
                $new_tab = isset( $link['glb_checkbox'] ) && $link['glb_checkbox'] ? '_blank' : '_self';
                if( isset( $link['glb_link'] ) ){ ?>
                <li>
                    <a href="<?php echo esc_url( $link['glb_link'] ); ?>" target="<?php echo esc_attr( $new_tab ); ?>" rel="nofollow noopener">
                        <?php echo wp_kses( good_looking_blog_social_icons_svg_list( $link['glb_icon'] ), get_kses_extended_ruleset() ); ?>
                    </a>
                </li>    	   
                <?php
                } 
...
if( ! function_exists( 'good_looking_blog_header_search' ) ) :
/**
 * Header search
 */
function good_looking_blog_header_search(){

$ed_search = get_theme_mod( 'ed_search', false );
if ( $ed_search ) { ?>
	<div class="header-search">
		<button aria-label="<?php esc_attr_e( 'search form toggle', 'good-looking-blog' ); ?>" data-toggle-target=".search-modal" data-toggle-body-class="showing-search-modal" data-set-focus=".search-modal .search-field" aria-expanded="false">
		...
		<div class="header-search-form search-modal cover-modal" data-modal-target-string=".search-modal">
			<div class="header-search-inner-wrap">'
				<?php get_search_form(); ?>
				<button aria-label="<?php esc_attr_e( 'search form close', 'good-looking-blog' ); ?>" class="close" data-toggle-target=".search-modal" data-toggle-body-class="showing-search-modal" data-set-focus=".search-modal .search-field" aria-expanded="false"></button>
			</div>
		</div>
	</div><!-- .header-seearch -->
<?php } 
...
if( ! function_exists( 'good_looking_blog_primary_menu_fallback' ) ) :
/**
 * Fallback for primary menu
*/
function good_looking_blog_primary_menu_fallback(){
	?>
        <div class="primary-menu-container">
			<ul id="primary-menu" class="nav-menu">
				<li><a href="<?php echo esc_url( admin_url( 'nav-menus.php' ) ); ?>"><?php echo esc_html__( 'Click here to add a menu', 'good-looking-blog' ); ?></a></li>
			</ul>
        </div>
	<?php 
}
...
if( ! function_exists( 'good_looking_blog_nav' ) ) :
/**
 * navigation
 */
function good_looking_blog_nav(){
	if( is_singular() ){ 
								...
								<article class="post">
									<figure class="post-thumbnail">
										...
										if( $prev_img ){
											...
											good_looking_blog_get_fallback_svg( 'thumbnail' );
										}?>
									</figure>
								<div class="pagination-details">
									<span class="meta-nav"><?php echo esc_html__( 'Previous', 'good-looking-blog' ); ?></span>
						...
						<div class="nav-next">
							<a href="<?php the_permalink( $next_post->ID ); ?>" rel="next">
								<article class="post">
									...
									<div class="pagination-details">
										<span class="meta-nav"><?php echo esc_html__( 'Next', 'good-looking-blog' ); ?></span>
									<header class="entry-header">
...
if ( ! function_exists( 'good_looking_blog_category' ) ) :
/**
 * Prints categories
 */
function good_looking_blog_category(){
...
function good_looking_blog_tag(){
    ...
    if ( 'post' === get_post_type() ) {
        ...
        if ( $tags_list ) {
            ...
            printf( '<div class="tags">' . esc_html__( '%1$sTags:%2$s %3$s', 'good-looking-blog' ) . '</div>', '<span>', '</span>', $tags_list );
        }
    }
}
endif;

if( ! function_exists( 'good_looking_blog_google_fonts_url' ) ) :
/**
 * Register google font.
 */
function good_looking_blog_google_fonts_url() {
    $fonts_url = '';
    ...
    */
    $playfairdisplay_font = _x( 'on', 'Playfair Display: on or off', 'good-looking-blog' );
    ...
    /* 
        ...
        * into your own language.
    */
    $montserrat_font = _x( 'on', 'Montserrat font: on or off', 'good-looking-blog' );

    if ( 'off' !== $playfairdisplay_font || 'off' !== $montserrat_font ) {
        $font_families = array();

        if ( 'off' !== $playfairdisplay_font ) {
            $font_families[] = 'Playfair Display:300,300i,400,400i,700,700i';
        }
...
if( ! function_exists( 'good_looking_blog_get_image_sizes' ) ) :
/**
 * Get information about available image sizes
 */
function good_looking_blog_get_image_sizes( $size = '' ) {
...
if ( ! function_exists( 'good_looking_blog_get_fallback_svg' ) ) :    
/**
 * Get Fallback SVG
*/
function good_looking_blog_get_fallback_svg( $post_thumbnail ) {
    if( ! $post_thumbnail ){
        return;
    }


    $image_size = good_looking_blog_get_image_sizes( $post_thumbnail );
...
if ( ! function_exists( 'good_looking_blog_author_meta' ) ) :
    /**
     * Author info for Banner and Editor Picks
     */
    function good_looking_blog_author_meta(){ ?>
        <div class="auth-details">
            <div class="author-desc">            
                <div class="author-details">
                    <?php echo get_avatar( get_the_author_meta( 'ID' ), 28, '', 'author' ); ?>
                    <div class="author-name">
                        <?php good_looking_blog_posted_by(); ?>
                    </div>
                </div>
                <span class="date">
...
if ( ! function_exists( 'good_looking_blog_single_author_meta' ) ) :
    /**
     * Author info for Single Post Banner
     */
    function good_looking_blog_single_author_meta(){   
        $ed_author          = get_theme_mod( 'ed_post_author', false );
        $ed_read_calc       = get_theme_mod( 'ed_post_read_calc', false );
        ...
        <div class="auth-details">
            <div class="author-desc">
                ...
                <?php } if( ! $ed_read_calc ) good_looking_blog_single_reading_calc( get_post( get_the_ID() )->post_content ); ?>
            </div>
        </div>
    <?php    
    }
...
if( ! function_exists( 'good_looking_blog_get_posts_list' ) ) :
/**
 * Returns Latest & Related 
*/
function good_looking_blog_get_posts_list( $status ){
    global $post;
    ...
    switch( $status ){
		...
		$reltitle         = __( 'You might also like', 'good-looking-blog' );
		$class            = 'recent-posts';
		$image_size       = 'good_looking_blog_popular_posts';
        break;
        ...
        $args['orderby']        = 'rand';
		$reltitle         		= get_theme_mod( 'related_post_title', __( 'You might also like', 'good-looking-blog' ) );
		$image_size       		= 'good_looking_blog_archive';
                        ...
                        <a href="<?php the_permalink(); ?>" class="post-thumbnail">
                            <?php
                                if( has_post_thumbnail() ){
                                    ...
                                    good_looking_blog_get_fallback_svg( $image_size );//fallback
                                }
                            ?>
                        </a>
                    </div>
...
if( ! function_exists( 'good_looking_blog_sidebar_layout' ) ) :
/**
 * Return sidebar layouts for pages/posts
 */
function good_looking_blog_sidebar_layout(){
    global $post;
	$return      = false;
	...
	if( is_singular() ){         
		if( get_post_meta( $post->ID, '_glb_sidebar_layout', true ) ){
			$sidebar_layout = get_post_meta( $post->ID, '_glb_sidebar_layout', true );
		}else{
...
if( ! function_exists( 'good_looking_blog_breadcrumb' ) ) :
/**
 * Breadcrumbs
*/
function good_looking_blog_breadcrumb(){ 
    global $post;
    $post_page  = get_option( 'page_for_posts' ); //The ID of the page that displays posts.
    $show_front = get_option( 'show_on_front' ); //What to show on the front page    
    $home       = get_theme_mod( 'home_text', __( 'Home', 'good-looking-blog' ) ); // text for the 'Home' link
    ...
    if( get_theme_mod( 'ed_breadcrumb', true ) ){
        $depth = 1;
        echo '<header class="page-header"> <div class="container"><div class="breadcrumb-wrapper"><div id="crumbs" itemscope itemtype="http://schema.org/BreadcrumbList">
        ...
        if( is_home() ){ 
            ...
            echo $before . '<a itemprop="item" href="'. esc_url( $request_uri ) . '"><span itemprop="name">' . sprintf( __( 'Search Results for "%s"', 'good-looking-blog' ), esc_html( get_search_query() ) ) . '</span></a><meta itemprop="position" content="'. absint( $depth ).'" />' . $after;        
        }elseif( is_day() ){            
            $depth = 2;
            echo '<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a href="' . esc_url( get_year_link( get_the_time( __( 'Y', 'good-looking-blog' ) ) ) ) . '" itemprop="item"><span itemprop="name">' . esc_html( get_the_time( __( 'Y', 'good-looking-blog' ) ) ) . '</span></a><meta itemprop="position" content="'. absint( $depth ).'" />' . $delimiter . '</span>';
            $depth++;
            echo '<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a href="' . esc_url( get_month_link( get_the_time( __( 'Y', 'good-looking-blog' ) ), get_the_time( __( 'm', 'good-looking-blog' ) ) ) ) . '" itemprop="item"><span itemprop="name">' . esc_html( get_the_time( __( 'F', 'good-looking-blog' ) ) ) . '</span></a><meta itemprop="position" content="'. absint( $depth ).'" />' . $delimiter . '</span>';
            $depth++;
            echo $before . '<a itemprop="item" href="' . esc_url( get_day_link( get_the_time( __( 'Y', 'good-looking-blog' ) ), get_the_time( __( 'm', 'good-looking-blog' ) ), get_the_time( __( 'd', 'good-looking-blog' ) ) ) ) . '"><span itemprop="name">' . esc_html( get_the_time( __( 'd', 'good-looking-blog' ) ) ) . '</span></a><meta itemprop="position" content="'. absint( $depth ).'" />' . $after;        
        }elseif( is_month() ){            
            $depth = 2;
            echo '<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a href="' . esc_url( get_year_link( get_the_time( __( 'Y', 'good-looking-blog' ) ) ) ) . '" itemprop="item"><span itemprop="name">' . esc_html( get_the_time( __( 'Y', 'good-looking-blog' ) ) ) . '</span></a><meta itemprop="position" content="'. absint( $depth ).'" />' . $delimiter . '</span>';
            $depth++;
            echo $before . '<a itemprop="item" href="' . esc_url( get_month_link( get_the_time( __( 'Y', 'good-looking-blog' ) ), get_the_time( __( 'm', 'good-looking-blog' ) ) ) ) . '"><span itemprop="name">' . esc_html( get_the_time( __( 'F', 'good-looking-blog' ) ) ) . '</span></a><meta itemprop="position" content="'. absint( $depth ).'" />' . $after;        
        }elseif( is_year() ){ 
            $depth = 2;
            echo $before .'<a itemprop="item" href="' . esc_url( get_year_link( get_the_time( __( 'Y', 'good-looking-blog' ) ) ) ) . '"><span itemprop="name">'. esc_html( get_the_time( __( 'Y', 'good-looking-blog' ) ) ) .'</span></a><meta itemprop="position" content="'. absint( $depth ).'" />'. $after;  
            ...
            if( get_query_var('paged') ){
                ...
                echo $before . sprintf( __('Page %s', 'good-looking-blog'), get_query_var('paged') ) . $after; 
            }else{
            ...
            $depth = 2;
            echo $before . '<a itemprop="item" href="' . esc_url( home_url() ) . '"><span itemprop="name">' . esc_html__( '404 Error - Page Not Found', 'good-looking-blog' ) . '</span></a><meta itemprop="position" content="' . absint( $depth ). '" />' . $after;
        }
        
        if( get_query_var('paged') ) printf( __( ' (Page %s)', 'good-looking-blog' ), get_query_var('paged') );
...
if ( ! function_exists( 'good_looking_blog_author_box' ) ) :
    /**
     * Author Box for Single Post and Archive Page
     */
    function good_looking_blog_author_box(){
...
if( ! function_exists( 'good_looking_blog_mobile_navigation' ) ) :
/**
 * Mobile Navigation
*/
function good_looking_blog_mobile_navigation(){ 
    ?>
            ...
            <div class="container">
                <div class="mob-nav-site-branding-wrap">
                    <div class="header-center">
                        <?php good_looking_blog_site_branding(); ?>
                    </div>
                ...
                <nav id="mobile-site-navigation" class="main-navigation mobile-navigation">        
                    <div class="primary-menu-list main-menu-modal cover-modal" data-modal-target-string=".main-menu-modal">                  
                        ...
                        <div class="mobile-social-wrap">
                            <?php if( good_looking_blog_social_links( false ) ){
                                echo '<div class="header-left"><div class="header-social">';
                                good_looking_blog_social_links();
                                echo '</div></div>';
                            } ?>  
                        </div>
                        <div class="mobile-menu" aria-label="<?php esc_attr_e( 'Mobile', 'good-looking-blog' ); ?>">
                            <?php
                                good_looking_blog_primary_navigation( false );
                            ?>
                        </div>
                    </div>
...
if( ! function_exists( 'good_looking_blog_comment' ) ) :
	/**
	 * Callback function for Comment List *
	 * 
	 * @link https://codex.wordpress.org/Function_Reference/wp_list_comments 
	 */
	function good_looking_blog_comment( $comment, $args, $depth ){
		if ( 'div' == $args['style'] ) {
			$tag = 'div';
			$add_below = 'comment';
		} else {
		...
		<?php endif; ?>
			...
			<footer class="comment-meta">
                ...
                <div class="author-details-wrap"><!-- .comment-author vcard -->
                    <?php printf( __( '<b class="fn" itemprop="creator" itemscope itemtype="http://schema.org/Person">%s <span class="says">says:</span></b>', 'good-looking-blog' ), get_comment_author_link() ); ?>
                    <div class="comment-meta-data">
                        <a href="<?php echo esc_url( htmlspecialchars( get_comment_link( $comment->comment_ID ) ) ); ?>">
                            <time itemprop="commentTime" datetime="<?php echo esc_attr( get_gmt_from_date( get_comment_date() . get_comment_time(), 'Y-m-d H:i:s' ) ); ?>"><?php printf( esc_html__( '%1$s at %2$s', 'good-looking-blog' ), get_comment_date(),  get_comment_time() ); ?></time>
                        </a>
                    </div>
                    <?php if ( $comment->comment_approved == '0' ) : ?>
                        <em class="comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.', 'good-looking-blog' ); ?></em>
                        <br />
                    <?php endif; ?>
                    ...
                    <div class="reply">
                        <?php comment_reply_link( array_merge( $args, array( 'reply_text' => __('Reply', 'good-looking-blog'), 'add_below' => $add_below, 'depth' => $depth, 'max_depth' => $args['max_depth'] ) ) ); ?>
                    </div>
                </div>
			</footer> 
		<?php if ( 'div' != $args['style'] ) : ?>
...
if( ! function_exists( 'good_looking_blog_single_reading_calc' ) ) :
    /**
     * Reading calculation
     */
    function good_looking_blog_single_reading_calc( $content ){ 
        $ed_read       = get_theme_mod( 'ed_post_read_calc', false );
        $read_calc     = get_theme_mod( 'read_words_per_minute', 200 );
        ...
        if ( ! $ed_read ) { ?>
            <div class="time">
                <?php echo absint( $time ) . esc_html__( ' Min Read', 'good-looking-blog' ); ?>
            </div>
        <?php }
    }
endif;
    
if( ! function_exists( 'good_looking_blog_footer_top' ) ) :
    /**
     * Footer Top
    */
    function good_looking_blog_footer_top(){    
...
if( ! function_exists( 'good_looking_blog_footer_site_info' ) ) :
/**
 * Footer site info
*/
function good_looking_blog_footer_site_info(){ 
	echo '<div class="site-info">';
		good_looking_blog_get_footer_copyright();
		good_looking_blog_ed_author_link();
		good_looking_blog_ed_wp_link();
	echo '</div>';
}
endif;

if( ! function_exists( 'good_looking_blog_footer_menu' ) ) :
    /**
     * Footer Menu
    */
    function good_looking_blog_footer_menu(){ 
...
if( ! function_exists( 'good_looking_blog_get_related_posts' ) ) :
    /**
     * Related post
    */
    function good_looking_blog_get_related_posts(){ ?>
        <div class="additional-post">
            <?php good_looking_blog_get_posts_list( 'related' ); ?>
        </div>
        <?php 
    }
endif;

if( ! function_exists( 'good_looking_blog_get_comments' ) ) :
    /**
     * Comments
    */
    function good_looking_blog_get_comments(){ 
...
if ( ! function_exists( 'good_looking_blog_social_icons_svg_list' ) ) :    
	/**
	 * Get SVG Image
	*/
	function good_looking_blog_social_icons_svg_list( $social ){
...
if( ! function_exists( 'good_looking_blog_contact_form' ) ) :
    /**
     * Contact form
    */
    function good_looking_blog_contact_form(){ 
        $form_title     = get_theme_mod( 'contact_form_title', __( 'Ready to Talk', 'good-looking-blog' ) );
        $form_shortcode = get_theme_mod( 'contact_form_shortcode' );
        if( $form_title || $form_shortcode ){ ?>
            <div class="contact-form-wrapper" id="contact-section">
                <div class="container">
                    <div class="form-wrap">
                        <?php if( $form_title ){ ?>
