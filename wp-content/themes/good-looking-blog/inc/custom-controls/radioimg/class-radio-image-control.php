<?php
/**
 * Good Looking Blog Customizer Radio Image Control.
 * 
...
if( ! class_exists( 'Good_Looking_Blog_Radio_Image_Control' ) ){
	/**
	 * Radio Image control (modified radio).
    */
	class Good_Looking_Blog_Radio_Image_Control extends WP_Customize_Control {
		...
		public function enqueue() {            
            wp_enqueue_style( 'good-looking-blog-radio-image', get_template_directory_uri() . '/inc/custom-controls/radioimg/radio-image.css', null );
            wp_enqueue_script( 'good-looking-blog-radio-image', get_template_directory_uri() . '/inc/custom-controls/radioimg/radio-image.js', array( 'jquery' ), false, true ); //for radio-image                
        }
