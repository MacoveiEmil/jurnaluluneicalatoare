<?php
/**
 * Good Looking Blog Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'Good_Looking_Blog_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class Good_Looking_Blog_Repeater_Setting extends WP_Customize_Setting {
